...
; (The former Optimize parameter was removed; Delta Mode 2 is what it used to mean.)
String Function TakePhoto(String basePath, String imageType, float jpgCompression, String Mode, float Duration, float Fps, int LoopCount, int DeltaMode, int Compression, float VideoDuration, int TargetResolution, int VideoFrameRate, int QualityPreset, int VideoBitrate, float KeyframeInterval, int EncoderPreference, int RateControl, int VideoContainer, bool Menu = true) Global Native
